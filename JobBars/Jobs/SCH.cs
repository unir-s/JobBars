...
namespace JobBars.Jobs {
    public static class SCH {
        ...
        public static CooldownConfig[] Cooldowns => [
            ...
            new CooldownConfig($"{UiHelper.Localize(ActionIds.Swiftcast)} ({UiHelper.Localize(JobIds.SCH)}) (60s)", new CooldownProps {
                Icon = ActionIds.Swiftcast,
                CD = 60,
                Triggers = [new Item(ActionIds.Swiftcast)]
            }, 0, 93),
            new CooldownConfig($"{UiHelper.Localize(ActionIds.Swiftcast)} ({UiHelper.Localize(JobIds.SCH)}) (40s)", new CooldownProps {
                Icon = ActionIds.Swiftcast,
                CD = 40,
                Triggers = [new Item(ActionIds.Swiftcast)]
            }, 94)
